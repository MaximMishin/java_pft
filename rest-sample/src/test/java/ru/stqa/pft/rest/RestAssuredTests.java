...
public class RestAssuredTests extends TestBase {
  ...
  public void testCreateIssue() throws IOException {
    ...
    Issue newIssue = new Issue().withSubject("Test issue max").withDescription("New test issue");
  ...
  public void testClose(){
    skipIfNotFixed(1247);
    System.out.println("закрыта таска открыт тест");
  }

  @Test
  public void testOpen(){
    skipIfNotFixed(1249);
    System.out.println("открыта таска закрыт тест");
  }
}
